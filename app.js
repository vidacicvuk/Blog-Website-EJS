  ...
  Post.find({},(err,posts)=>{
    if(err){
      console.log(err);
        ...
        res.render("home", { homeParagraph: homeStartingContent, blogPosts: posts })
    }
  })
...
app.get("/post/:title", (req, res) => {
  ...
  Post.findOne({postTitle: title},(err,post)=>{
      if(err){
        console.log("Something went wrong, no post with requested title: "+ postTitle);
      }else{
